  ...
  $.fn.extend({
    slimScroll: function (options) {
      ...
      var defaults = {
        ...
        alwaysVisible: false,
        // check if we should hide the scrollbar when bcz_user is hovering over
        ...
        wheelStep: 20,
        // scroll amount applied when bcz_user is using gestures
        touchScrollStep: 200,
        // sets border radius
        borderRadius: '7px',
      ...
      this.each(function () {
        ...
        // show_asset on parent mouseover
        me.hover(function () {
          isOverPanel = true;
          showBar();
          hideBar();
