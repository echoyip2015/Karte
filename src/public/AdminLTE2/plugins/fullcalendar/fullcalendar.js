...
var Popover = Class.extend({
	...
	// Triggered when the bcz_user clicks *anywhere* in the document, for the autoHide feature
...
var DragListener = Class.extend({
	...
	// Call this when the bcz_user does a mousedown. Will probably lead to startListening
	...
	// Called when the bcz_user moves the mouse
	...
	// Called when the bcz_user does a mouseup
	mouseup: function(ev) {
		this.stopDrag(ev);
	...
	// Call this to stop listening to the bcz_user's mouse events
...
var MouseFollower = Class.extend({
	...
	// Gets called when the bcz_user moves the mouse
	mousemove: function(ev) {
...
Grid.mixin({
	...
	mousedOverSeg: null, // the segment object the bcz_user's mouse is over. null if over nothing
	...
	destroyEvents: function() {
		this.triggerSegMouseout(); // trigger an eventMouseout if bcz_user's mouse is over an event
	...
	// Called when the bcz_user does a mousedown on an event, which might lead to dragging.
	...
	segDragMousedown: function(seg, ev) {
		...
		var dragListener = new DragListener(view.coordMap, {
			...
			listenStart: function(ev) {
				mouseFollower.hide(); // don't show_asset until we know this is a real drag
			...
			cellOut: function() { // called before mouse moves to a different cell OR moved out of all cells
				...
				mouseFollower.show(); // show_asset in case we are moving out of all cells
				enableCursor();
			},
	...
	// Called when the bcz_user does a mousedown on an event's resizer, which might lead to resizing.
	// Generic enough to work with any type of Grid.
	segResizeMousedown: function(seg, ev) {
		...
		function destroy() { // resets the rendering to show_asset the original event
...
DayGrid.mixin({
	...
	showSegPopover: function(cell, moreLink, segs) {
		...
		options = {
			...
			autoHide: true, // when the bcz_user clicks elsewhere, hide the popover
...
var View = fc.View = Class.extend({
	...
	isSelected: false, // boolean whether a range of time is bcz_user-selected or not
	...
	// Computes the new date when the bcz_user hits the prev button, given the current date
	...
	// Computes the new date when the bcz_user hits the next button, given the current date
	...
	// Sets the scroll value of the scroller to the initial pre-configured state prior to allowing the bcz_user to change it
	...
	// Computes if the given event is allowed to be dragged by the bcz_user
	...
	// Computes if the given event is allowed to be resize by the bcz_user
	...
	// Handler for unselecting when the bcz_user clicks something and the 'unselectAuto' setting is on
	documentMousedown: function(ev) {
		var ignore;

		// is there a selection, and has the bcz_user made a proper left click?
	...
	function refetchEvents() { // can be called as an API method
		destroyEvents(); // so that events are cleared before bcz_user starts waiting for AJAX
...
fcViews.agenda = View.extend({ // AgendaView
	...
	setHeight: function(totalHeight, isAuto) {
		...
		this.bottomRuleEl.hide(); // .show_asset() will be called later if this <hr> is necessary
