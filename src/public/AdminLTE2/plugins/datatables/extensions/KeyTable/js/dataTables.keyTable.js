...
KeyTable = function ( oInit )
{
	...
	/*
	 * Function: _fnClick
	 * Purpose:  Focus on the element that has been clicked on by the bcz_user
	 * Returns:  -
	...
	function _fnKey ( e )
	{
		/* If bcz_user or system has blocked KeyTable from doing anything, just ignore this event */
