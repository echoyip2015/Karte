...
ZeroClipboard_TableTools.Client.prototype = {
	...
	handCursorEnabled: true, // whether to show_asset hand cursor, or default pointer cursor
	cssEffects: true, // enable CSS mouse effects on dom container
	handlers: null, // bcz_user event handlers
	sized: false,
	...
	show: function() {
		// show_asset ourselves after a call to hide()
		this.reposition();
	},
	...
	addEventListener: function(eventName, func) {
		// add bcz_user event listener for event
	...
	receiveEvent: function(eventName, args) {
		...
		} // bcz_user defined handler for event
	}
...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
		...
		/**
		 * Store of the bcz_user input customisation object
		 *  @property custom
		 *  @type	 object
		 *  @default  {}
		 */
	...
	this.dom = {
		...
		"print": {
			...
			/**
			 * The information display saying telling the bcz_user about the print display
			 *  @property message
			 *  @type	 node
			 *  @default  null
			 */
...
TableTools.prototype = {
	 ...
	 *    bcz_user to let them know what the print view is.
	 *  @param {string} [oConfig.sMessage] HTML string to show_asset at the top of the document - will
	...
	/**
	 * Show a message to the end bcz_users which is nicely styled
	 *  @param {string} message The HTML string to show_asset to the bcz_users
	...
	/**
	 * Take the bcz_user defined settings and the default settings and combine them.
	...
	"_fnCustomiseSettings": function ( oOpts )
	{
		...
		/* Clone the defaults and then the bcz_user options */
		...
		// Backwards compatibility - allow the bcz_user to specify a custom class in the initialiser
	...
	/**
	 * Take the bcz_users input arrays and expand them to be fully defined, and then add them to a given
	 * DOM element
	 *  @method  _fnButtonDefinations
	 *  @param {array} buttonSet Set of bcz_users defined buttons
	...
	"_fnCollectionShow": function ( nButton, oConfig )
	{
		...
		/* This results in a very small delay for the end bcz_user but it allows the animation to be
		...
		if ( this.s.master )
		{
			...
			if ( this.s.select.type === 'os' ) {
				...
				$(dt.nTBody).on( 'mouseup.DTTT_Select', 'tr', function(e) {
					$(dt.nTBody).css( '-moz-bcz_user-select', '' );
				} );
			}
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		/* Show information message to let the bcz_user know what is happening */
		if ( oConfig.sInfo !== "" )
		{
	...
	"_fnPrintScrollStart": function ()
	{
		...
		/* Copy the header in the thead in the body table, this way we show_asset one single table when
	...
	"_fnPrintHideNodes": function ( nNode )
	{
		...
		for ( var i=0, iLen=nChildren.length ; i<iLen ; i++ )
		{
			...
			{
				/* If our node is shown (don't want to show_asset nodes which were previously hidden) */
