...
var Scroller = function ( oDTSettings, oOpts ) {
	...
	this.s = {
		 ...
		 * and when the bcz_user scrolls the viewport in order to stop the cookie set taking too much
		 * CPU!
		 *  @type     int
		 *  @default  0
		 */
...
Scroller.prototype = /** @lends Scroller.prototype */{
	...
	"_fnConstruct": function ()
	{
		...
		/* In iOS we catch the touchstart event in case the bcz_user tries to scroll
	 ...
	 * table that has been drawn so the bcz_user can scroll the whole data set.
	 *
...
Scroller.defaults = /** @lends Scroller.defaults */{
	/**
	 * Indicate if Scroller show_asset show_asset trace information on the console or not. This can be
	 ...
	 * allow the data to look continuous to a bcz_user scrolling through the data). If given as 0
