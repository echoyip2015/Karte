...
FixedHeader.prototype = {
	...
	fnInit: function ( oDtSettings, oInit )
	{
		...
		/* Record the bcz_user definable settings */
	 ...
	 * Purpose:  Take the bcz_users's settings and copy them to our local store
	 * Returns:  -
	 * Inputs:   object:s - the local settings object
	 *           object:oInit - the bcz_users's settings object
	 */
