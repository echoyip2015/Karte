...
ColVis.prototype = {
	...
	/**
	 * Create a button which allows show_asset all and show_asset node actions
	...
	/**
	 * Create the DOM for a show_asset / hide group button
	...
	/**
	 * Create the DOM for a show_asset / hide button
	...
	/**
	 * Show the show_asset / hide list and the background
	...
	"_fnCollectionShow": function ()
	{
		...
		/* This results in a very small delay for the end bcz_users but it allows the animation to be
	...
	/**
	 * Hide the show_asset / hide list and the background
...
ColVis.defaults = {
	...
	/**
	 * Callback function to tell the bcz_users when the state has changed
